...
subroutine evaluate_wave_transmission_c(n_time,heartrate,a0,no_freq,&
  a,b,n_bcparams,bc_params) bind(C, name="evaluate_wave_transmission_c")
...
call so_evaluate_wave_transmission(n_time,heartrate,a0,no_freq,a,b,n_bcparams,bc_params)
#else
call evaluate_wave_transmission(n_time,heartrate,a0,no_freq,a,b,n_bcparams,bc_params)
#endif
