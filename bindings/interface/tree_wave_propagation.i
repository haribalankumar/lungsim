...
%inline %{
void my_evaluate_wave_propagation(double a0, int len1, double* vec1, int len2, double* vec2, int len3, double* vec3) {
    if (len1 != len2) {
    ...
    evaluate_wave_propagation(a0, len1, vec1, vec2, len3, vec3);
}
%}
