...
!##########################################################################
  ...
  !  element
  ! Assumes pre-existing lung mesh already read in (in form of ipnode and ipelem)
  ! and a 3D distributed point cloud (e.g. lung tissue density from CT)
  ! It then works out a simple subtraction using the 
  ! triangles_from_selectsurface subroutine
  ! This subroutine is modified from the orig. triangles_from_surface subroutine.
