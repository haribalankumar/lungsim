...
!!! allocate dependent variable arrays
    ...
    write(*,*) 'num_elems_2d, nmax_data_elem, num_data, ny_max'
    write(*,*) num_elems_2d, nmax_data_elem, num_data, ny_max
...
!!! local variables
    ...
    write(*,*) 'inside define geom fit'
    write(*,*) num_nodes_2d, num_deriv
...
!HBK Commented
    ...
    read_mapped_nodes : do
       ...
       write(*,*) 'number of maps=',number_of_maps
    ...
    write(*,*) 'calling map versions in fit surface'
    ...
    write(*,*) 'Exiting define geometry fit'
...
!!!    node, version, derivative >> node, version, derivative, mapping coefficient
    ...
    write(*,*) 'num of depvar=',num_depvar
